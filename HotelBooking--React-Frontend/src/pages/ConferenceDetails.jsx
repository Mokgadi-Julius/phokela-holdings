...
const ConferenceDetails = () => {
  ...
  useEffect(() => {
    servicesAPI.getById(id)
      ...
      .catch(err => console.error('Error fetching conference service:', err))
  ...
  if (!service) {
    return (
      <div className='min-h-screen pt-[120px] flex items-center justify-center text-center px-4'>
        <div>
          <p className='text-xl text-gray-600 mb-4'>Conference package not found.</p>
          <Link to='/conference' className='text-accent underline'>Back to Conference</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <section className='min-h-screen pt-[120px] pb-16'>
      ...
      <div className='container mx-auto px-4 py-12'>
        ...
        {/* Back link */}
        <Link to='/conference' className='inline-flex items-center gap-2 text-accent hover:underline mb-8'>
        ...
        <div className='flex flex-col lg:flex-row lg:gap-x-10'>
          ...
          <div className='w-full lg:w-[40%] mt-10 lg:mt-0'>
            <div className='bg-accent/10 rounded-lg p-6 sticky top-[140px]'>
              ...
              <div className='text-sm text-gray-500 mb-6'>venue only · starting price</div>
              ...
              <div className='bg-white rounded-lg p-4 mb-5 text-sm text-gray-600 border border-gray-200'>
                ...
                <p>Contact us via WhatsApp or email to discuss your requirements. A signed contract is required before any deposit is taken.</p>
              </div>
