...
const EventDetails = () => {
  ...
  useEffect(() => {
    servicesAPI.getById(id)
      ...
      .catch(err => console.error('Error fetching event service:', err))
  ...
  if (!service) {
    return (
      <div className='min-h-screen pt-[120px] flex items-center justify-center text-center px-4'>
        <div>
          <p className='text-xl text-gray-600 mb-4'>Event package not found.</p>
          <Link to='/events' className='text-accent underline'>Back to Events</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <section className='min-h-screen pt-[120px] pb-16'>
      ...
      <div className='container mx-auto px-4 py-12'>
        ...
        {/* Back link */}
        <Link to='/events' className='inline-flex items-center gap-2 text-accent hover:underline mb-8'>
