        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="bookingDetails.checkIn:asc">Check-in: Earliest First</option>
              <option value="bookingDetails.checkIn:desc">Check-in: Latest First</option>
            </select>
          </div>
          ...
          <div className="flex items-end">
            <button
              onClick={() => setFilters({ status: '', category: '', sortBy: 'createdAt', order: 'desc', page: 1, limit: 10 })}
